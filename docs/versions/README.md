...
- Public releases use semantic versions: `v0.1.0`, `v0.1.1`, `v0.2.0`, `v0.2.1`, `v0.2.2`, `v0.2.3`, `v0.2.4`, `v0.2.5`, `v0.2.6`, `v0.2.7`.
...
- `v0.2.7`: current production version with winery website shown only from the wine record and PWA install guidance limited to the side menu.
