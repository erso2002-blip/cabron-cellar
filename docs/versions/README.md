...
- `v0.2.59`: current production version showing drink-date source/confidence on the main wine detail card.
- `v0.2.58`: production version with stable profile-based drink-date fallback when no strong source is found.
